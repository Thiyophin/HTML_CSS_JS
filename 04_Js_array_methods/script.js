...
console.log("Table of inventors born in 1500s :-")
console.table(inventorsBornIn1500s)

// Array.prototype.map()
// 2. Give us an array of the inventors first and last names
const fullNames = inventors.map(inventor => (`${inventor.first} ${inventor.last}`))
console.log(`Array of inventors : ${fullNames}`)

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
const ordered = inventors.sort((a,b) => a.year > b.year ? 1 : -1)
console.log("Table of sorted inventors by birthdate :-")
console.table(ordered)

// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const totalYearsLived = inventors.reduce((total,inventor) => total + (inventor.passed - inventor.year),0)
console.log(`Total number of years lived by inventors : ${totalYearsLived}`)
...
console.log('Inventors lived longer sorted : ')
